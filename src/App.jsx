    ...
    <>
      ...
      <div className="tentang mt-32 py-10">
        ...
        <div className='tools mt-32'>
          ...
          <p className='xl:w-2/5 lg:w-2/4 md:w-2/3 sm:w3/4 w-full text-base/loose opacity-50'>Berikut ini beberapa tools yang biasa saya pakai untuk pembuatan website</p>
