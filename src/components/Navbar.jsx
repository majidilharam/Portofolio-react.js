...
const Navbar = () => {
    ...
    <div className="logo">
        <h1 className="text-4xl font-bold bg-shadow-blue text-white p-1 md:bg-transparent
        ">Portofolio</h1>
    </div>
    ...
    transition-all md:transition-none z-10 ${active ? "top-0 opacity-100" : "-top-10 opacity-0"}`}>
        ...
        <li><a href="#proyek" className="sm:text-lg text-base font-medium">Certifications</a></li>
